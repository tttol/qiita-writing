...
リンクを踏むとAmplifyの画面が別タブで開かれます。アプリケーションの名前・ブランチ名・配信元の選択を促されます。配信元は既に先程のS3バケットがフィルインされていますね。
...
![スクリーンショット 2024-11-01 8.21.05.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/159675/5320006f-88e6-e104-6092-6803b92e1390.png)
